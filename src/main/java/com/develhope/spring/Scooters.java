...
public class Scooters extends Vehicles {
	public Scooters(Long id, String type, String brand, String model, Integer displacement, String color, String power, String transmissionType, Integer yearOfRegistration, String fuelType, int price, int discountPrice, String accessories, String condition, boolean available, boolean purchaseable, boolean rentable, boolean orderable) {
